...
// wanted-set filter, CRC-32, ZIP round-trip, folder/directory sinks,
// format/game-ID validation, the full iso-source pipeline against the
// synthetic fixture, and packager orchestration) plus the LOCAL-ONLY real
// ISO integration test, which self-reports SKIP unless $MP6_ISO is set --
// see test/integration/real-iso.test.js and the feature report for exact
// numbers measured against the real disc.
//

 ...
 * chain (see src/android/mp6shell.c):
 *
 ...
 *     native nod importer). src/android/saf_bridge.c polls these
 ...
 *     Contract mirror of src/content/content_import.cpp: same wanted
...
public class Mp6Activity extends SDLActivity {
    ...
    protected String getMainFunction() {
        return "mp6_android_main"; // src/main_native.c's android entry
    }
    ...
    private void hideSystemBars() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (controller != null) {
                ...
                // Do not hide the IME: console typing still needs the keyboard.
     ...
     * Java half of src/android/saf_bridge.c.
     * =================================================================== */

    private static final int MP6_REQUEST_FOLDER = 0x4D36; // 'M''6'; clear of SDL's dialog codes

    // Import state values -- MUST mirror src/content/content_import.h.

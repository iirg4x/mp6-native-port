/* MP6 native port -- the game-event bus. See shim/include/mp6_events.h for
...
void mp6_event_scan_line(const char *line)
{
    ...
    /* --- REL lifecycle (src/game/objdll.c + platform/os/dll_bridge.c) - */
    ...
    /* platform/os/dll_bridge.c's own "[BOOT] OSLink: bound w01Dll prolog/
    ...
    /* patches/decomp/src/REL/w01Dll/world01.c's own markers, already the

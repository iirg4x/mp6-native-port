 ...
 * platform/gx/aurora_bridge.c -- which is AURORA-ONLY (tools/build.py's
 ...
 * START (platform/null/shims_manual.c's PADRead), which cannot press A and
 ...
 * own tick counter and the in-process event bus (shim/include/mp6_events.h),
 ...
 *   - the headless build from platform/null/shims_manual.c's

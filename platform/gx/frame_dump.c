/* MP6 native port -- debug lever: MP6_FRAME_DUMP. See shim/include/
 ...
 *
 * Lives in platform/gx/ next to framescope.c and shadow_dump.c -- the same
 ...
 * #ifdef, because its trigger entry point is called from platform/os/

 ...
 * compat/decomp/src/game/hsfman.c.patch's Hu3DShadowMultiCreate (the only
 ...
 *
 * Two definitions exist (src/hsf/mp6_shadow_quality.c, split
 ...
 * ENHANCEMENTS SEAM (include/mp6_enhancements.h) via
 ...
 * of mp6_shadow_effective_size(), so render/copy sizes always match the
 * allocation. Live settings replace and re-latch the buffer between frames.
 * The latch table is ordinary

 ...
 * Mods-page Shadow Quality feature, include/mp6_shadow_quality.h,
 ...
 * tick, see src/gx/aurora_bridge.c's VIWaitForRetrace, right after
 ...
 * successful dumps (see src/gx/shadow_dump.c) so a long run never
...
/* Called once per tick (src/gx/aurora_bridge.c's VIWaitForRetrace,

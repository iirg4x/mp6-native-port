 ...
 *
 * This module (src/hsf/hsf_load_native.c) is a DESERIALIZER, not an
 * in-place patch: it reads the big-endian, 32-bit-offset file bytes
 * explicitly (byte-at-a-time, alignment-agnostic, via include/be.h)
 ...
 *
 * compat/decomp/src/game/hsfload.c.patch's LoadHSF() calls

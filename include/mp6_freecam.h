 ...
 * the top of Hu3DExec() (game/hsfman.c, via compat/decomp), which runs
 ...
 *   - src/hsf/mp6_freecam.c (decomp headers; BOTH build modes): the
 ...
 *   - src/gx/freecam_input.c (aurora headers; windowed builds only):

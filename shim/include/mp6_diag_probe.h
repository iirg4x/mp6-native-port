 ...
 *     it before anything is formatted. platform/audio/msm_bridge.c states the
...
/* ---------------------------------------------------------------------
 * HuMem heaps -- platform/os/malloc_direct.c.
...
/* ---------------------------------------------------------------------
 * OS arena heaps -- platform/os/arena.c's bump table.
 * ------------------------------------------------------------------- */
typedef struct {
    int                valid;
    const void        *cur;
...
/* ---------------------------------------------------------------------
 * Audio -- platform/audio/msm_bridge.c. One snapshot call, taken under the
...
/* ---------------------------------------------------------------------
 * Board -- platform/os/board_runtime.c's live counters (today they feed one
...
/* ---------------------------------------------------------------------
 * Event bus -- platform/os/mp6_events.c.
 *
...
/* ---------------------------------------------------------------------
 * HuPrc scheduler -- platform/os/process_native.c.
 *
...
/* ---------------------------------------------------------------------
 * OM object walk -- patches/decomp/src/game/objmain.c.patch.
 *
...
/* ---------------------------------------------------------------------
 * Unlocked FPS -- platform/gx/frame_interp.c. WINDOWED BUILD ONLY (that TU

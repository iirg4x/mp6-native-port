 ...
 * Unlocked-FPS layer (platform/gx/frame_interp.c) pushes through
 ...
 *                              shim/include/mp6_events.h). If unset, the
 ...
 * platform/gx/shadow_dump.c uses for aurora-patches/0016.
 */

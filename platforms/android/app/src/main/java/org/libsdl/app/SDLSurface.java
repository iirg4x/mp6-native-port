...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    /* MP6 native port: aurora's android
     ...
     * never calls it, which leaves aurora paused forever (poll_events blocks
     * in SDL_WaitEvent); this vendored copy adds the declaration + the three
     * call sites, the same modification the MP4 port's shell carries. */
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        auroraNativeSetSurfaceReady(false); /* MP6/U-A2: aurora lifecycle hook */
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        auroraNativeSetSurfaceReady(true); /* MP6/U-A2: aurora lifecycle hook */

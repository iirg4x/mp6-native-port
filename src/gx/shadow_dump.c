/* MP6 native port -- debug lever: MP6_SHADOW_DUMP. See include/
 ...
 *
 * Lives in src/gx/ (not src/hsf/, where mp6_shadow_quality.c
 ...
 * same category src/gx/framescope.c's own header comment documents

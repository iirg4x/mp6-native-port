...
/* Shared tab indices; Game is the guided game-selection destination used by
 * the launch screen. Android adds Touch Controls after Advanced; Save States
 * follows during play. */
...
inline constexpr int kSettingsTabAdvanced = 4;

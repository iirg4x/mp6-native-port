 ...
 * runtime lever live in src/gx/console/console_core.c
 * (include/mp6_console.h), which links headless and is driven directly by
 ...
 * one proven end to end in this tree: src/gx/ui/string_button.cpp creates
 ...
 * include/mp6_console.h) out under `parent`, replacing its contents.
 *
...
private:
    ...
    bool mPendingCompletion = false;
    std::vector<Rml::String> mAcMatch;
};

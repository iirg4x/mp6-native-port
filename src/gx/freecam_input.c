...
extern int mp6_launcher_menu_visible(void); /* src/gx/ui/launcher_core.cpp */
#ifdef __ANDROID__
extern int mp6_touch_pad_control_at(float nx, float ny); /* src/android/touch_pad.cpp */
#endif

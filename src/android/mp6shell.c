 ...
 *      nativeRunMain -> mp6_android_main handoff (src/
 ...
 *     staying OFF src/os/arena.c's own candidate list
...
/* =======================================================================
 * Low image reservation -- VERBATIM from src/android/mp6launcher.c

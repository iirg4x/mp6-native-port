...
/* Sizing: src/os/malloc_direct.c's HeapSizeTbl requests ~98MB across
 ...
 * boot. mp6_heap_arena_bytes() (include/mp6_heap_scale.h) is
 ...
 * unchanged. The scale is latched process-wide (src/os/heap_scale.c),
 ...
 * it against the loading process's own (src/os/savestate.c). It reads
...
/* Pull-side arena snapshot (include/mp6_diag_probe.h). The [HEAPTRACE]

/* MP6 native port -- freecam camera override (include/mp6_freecam.h
 * has the design contract; this is the decomp-header half).
 *
 * Lives in src/hsf/ (alongside mp6_widescreen_extrude.c) because it
 ...
 * (src/gx/freecam_input.c); in headless builds nothing ever calls

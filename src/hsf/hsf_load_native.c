 ...
 * See include/mp6_hsf_native.h for the architecture summary and the
 ...
 * (see src/gx/aurora_bridge.c's mp6_GXSetArray3), so an in-place morph
 ...
 * compat/decomp/src/game/hsfmotion.c.patch adds the matching bounds check
...
static void LoadMotion(LoadCtx *ctx)
{
    ...
    for (i = 0; i < numTracks; i++) {
        ...
        case HSF_TRACK_CLUSTER_WEIGHT:
             ...
             * (compat/decomp/src/game/hsfmotion.c.patch for Hu3DMotionExec,
             * compat/decomp/src/game/ClusterExec.c.patch for

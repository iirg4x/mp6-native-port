 ...
 * (src/os/process_native.c) runs every game process on its own
 ...
 * src/host/minicoro.h, v0.2.0) with MCO_USE_ASM -- its assembly
 ...
 * 256 MB at x1, 550 MB at x4 -- include/mp6_heap_scale.h): at x4 the
 ...
 * restore could perform, and src/os/savestate.c correctly refuses any
